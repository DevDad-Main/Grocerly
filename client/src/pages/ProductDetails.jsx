      ...
      <div className="mt-12">
        ...
        <div className="flex flex-col items-center mt-20">
          ...
          <button
            ...
            className="mx-auto cursor-pointer px-12 my-16 py-2.5 border-rounded bg-primary text-white hover:bg-primary-dull hover:-translate-y-0.5 transition duration-200"
          >
            See More
          </button>
        </div>
