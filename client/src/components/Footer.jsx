...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col items-center justify-around w-full py-16 text-sm text-gray-800/70 mt-24">
        <div className="flex items-center gap-8">
          <Link
            to={"/"}
            className="font-medium text-gray-500 hover:text-black hover:-translate-y-0.5 transition-all duration-300"
          >
            Home
          </Link>
        ...
        <p className="mt-8 text-center">
          Copyright © 2025 <a href="https://github.com/DevDad-main">Dev Dad</a>
